...
const (
	welcomeMessage = "List available server-integrated backups from the configured storage."
	shortMessage   = "List server-integrated backups"
)
...
func NewCmd(shared *subcmd.SharedFlags, flagsRoot *flags.Root, appVersion, commitHash, buildTime string,
	...
	cmd.SetHelpFunc(func(_ *cobra.Command, _ []string) {
		newHelpFunction(flags.SectionTextUsageBackupList, ssbFlagSet, awsFlagSet)
	})
